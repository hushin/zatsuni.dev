...
昨年（2025年）は私にとってAIコーディングエージェント（以下 AI Agent）の利用が進んだ一年だった。
...
AIは使う人間の能力以上のものは作れないとよく言われている。
使う人間が知らない技術を使って作ってくれるが、仕事では責任が取れない。
AI活用で空いた時間を学習・手を動かすことに当てて自分の能力を広げたい。
